...
describe('MoviesListActions', () => {
    ...
    it('should create InitializeSearchCriteriaFromCache action', () => { 
        ...
        expect(action.type).toEqual(MoviesListActionTypes.INITIALIZE_SEARCH_CRITERIA_FROM_CACHE);
    ...
    it('should create ChangeSearchMaxResults action', () => { 
        ...
        expect(action.type).toEqual(MoviesListActionTypes.CHANGE_SEARCH_MAX_RESULTS);
        expect(action.payload).toEqual(
            87654
        );
    })
    ...
    it('should create LoadMoviesListSuccess action', () => { 
        ...
        expect(action.type).toEqual(MoviesListActionTypes.LOAD_MOVIES_BY_CRITERIA_SUCCESS);
        expect(action.payload).toEqual({
            collection: [ new Movie() ],
            total: 54321
        });
    ...
    it('should create LoadMoviesListFail action', () => { 
        ...
        expect(action.type).toEqual(MoviesListActionTypes.LOAD_MOVIES_BY_CRITERIA_FAIL);
    })
