...
export class ListSettingsComponent implements OnInit, OnDestroy {
  ...
  public changeCriteria(type: SearchType): void {
    console.warn(
      `ATTENTION! Please keep in mind sorting by direction fails on the backend therefore it doesn't work. Functionality responible for sorting is implemented and need to be just uncommented in movie.service.ts`
    );
